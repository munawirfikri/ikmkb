...
<figure class="wp-block-image size-large is-style-hover-zoom"><a href="#" target="_blank" rel="noreferrer noopener"><img src="<?php echo esc_url( get_theme_file_uri("assets/media/content/play-button.svg") ); ?>" alt="" class="wp-image-2983"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group --></div>
